...
class PGP {
					...
					foreach($WPGP_AllPhotosDetails as $WPGP_SinglePhotoDetails) {
						...
						<li class="pgp-image-entry" id="rpg_img">
							...
							<div class="pgp-admin-inner-div1" >
								...
								<img src="<?php echo $url1; ?>" class="pgp-meta-image" alt=""  style="">
							...
							<div class="pgp-admin-inner-div2" >
								...
								<input type="text" id="PGP_image_url[]" name="PGP_image_url[]" class="pgp_label_text"  value="<?php echo $url; ?>"  readonly="readonly" style="display:none;" />
								<input type="text" id="PGP_gallery_admin_thumb[]" name="PGP_gallery_admin_thumb[]" class="pgp_label_text"  value="<?php echo $url1; ?>"  readonly="readonly" style="display:none;" />
								<input type="text" id="PGP_gallery_admin_medium[]" name="PGP_gallery_admin_medium[]" class="pgp_label_text"  value="<?php echo $url2; ?>"  readonly="readonly" style="display:none;" />
								<input type="text" id="PGP_gallery_admin_circle[]" name="PGP_gallery_admin_circle[]" class="pgp_label_text"  value="<?php echo $circle; ?>"  readonly="readonly" style="display:none;" />
				
								<p>
									<label><?php _e('Label','PGP_TEXT_DOMAIN')?></label>
									<input type="text" id="PGP_image_label[]" name="PGP_image_label[]" value="<?php echo $name; ?>" placeholder="Enter Label Here" class="pgp_label_text">
								</p>
								<p>
									...
									<input type="text" id="PGP_video_link[]" name="PGP_video_link[]" value="<?php echo $video; ?>" placeholder="Enter Youtube/Vimeo Video URL" class="pgp_label_text">
								</p>
								<label><?php _e('Link','PGP_TEXT_DOMAIN')?></label>
								<input type="text" id="PGP_external_link[]" name="PGP_external_link[]" value="<?php echo $link; ?>" placeholder="Enter Link URL" class="pgp_label_text">
							</div>
						</li>
						<?php
					} // end of foreach
		...
		if(isset($PostID) && isset($_POST['PGP_wl_action'])) {
			...
			if($TotalImages) {
				for($i=0; $i < $TotalImages; $i++) {
					$image_label = stripslashes($_POST['PGP_image_label'][$i]);
					$url = $_POST['PGP_image_url'][$i];
					$url1 = $_POST['PGP_gallery_admin_thumb'][$i];
					$url2 = $_POST['PGP_gallery_admin_medium'][$i];
					$circle = $_POST['PGP_gallery_admin_circle'][$i];
					$video = $_POST['PGP_video_link'][$i];
					$link = $_POST['PGP_external_link'][$i];
					$type = $_POST['PGP_portfolio_type'][$i];
					$ImagesArray[] = array(
	...
	public function PGP_settings_meta_save($PostID) {		
	  if(isset($PostID) && isset($_POST['PGP_Show_Gallery_Title'])){
		...
		$PGP_Effect				= $_POST['PGP_Effect'];
		$PGP_Effect_animation	= $_POST['PGP_effect11_anim'];
		$PGP_Show_Gallery_Title = $_POST['PGP_Show_Gallery_Title'];
