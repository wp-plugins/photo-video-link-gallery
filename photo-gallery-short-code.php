				...
				if($TotalImages) {
					foreach($PGP_AllPhotosDetails as $PGP_SinglePhotoDetails)
					{
						...
						<div class="<?php echo $PGP_Gallery_Layout; ?> item_margin col-sm-6">
						  ...
						  <a href="<?php echo $href_link; ?>" title="<?php if( $PGP_Show_Image_Label =="yes"){ echo $name; } ?>"
						  <?php  
							if($type != "link"){  ?> class="swipebox_<?php echo $PGP_Id; ?>" <?php  } else{ ?> target="<?php echo $PGP_Open_Link; ?>" <?php } 
								 ?> >
							  <div class="img"><img src="<?php echo $circle; ?>" ></div>
							  <div class="info">
